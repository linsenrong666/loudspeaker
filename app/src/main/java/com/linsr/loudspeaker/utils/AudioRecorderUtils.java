 ...
 * Description
 *
 * @author linsenrong on 2017/7/11 16:27
 */
...
public class AudioRecorderUtils {
     ...
     * 文件存储默认sdcard/record
     */
    public static String getRecordsPath(Context context) {
        return FileUtils.getWorkingDirectory(context) + "/records/";
    }

    public AudioRecorderUtils(Context context) {
        mContext = context;
        String filePath = getRecordsPath(mContext);
    ...
    public void startRecord() {
        ...
        try {
            ...
            mFilePath = FolderPath + System.currentTimeMillis() + ".amr";
            /* ③准备 */
